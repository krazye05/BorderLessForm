...
Namespace Borderlessclass
    ...
    Public Enum SystemCommands
        ...
        SC_MINIMIZE = &HF020
        SC_MAXIMIZE = &HF030
        SC_MAXIMIZE2 = &HF032   ' fired from double-click on caption
        SC_NEXTWINDOW = &HF040
        SC_PREVWINDOW = &HF050
        SC_CLOSE = &HF060
        SC_VSCROLL = &HF070
        ...
        SC_ARRANGE = &HF110
        SC_RESTORE = &HF120
        SC_RESTORE2 = &HF122    ' fired from double-click on caption
        SC_TASKLIST = &HF130
        SC_SCREENSAVE = &HF140
        SC_HOTKEY = &HF150
        SC_DEFAULT = &HF160
    ...
    Public Structure NativeMessage
        ...
        Public p As Drawing.Point
    End Structure
    <StructLayout(LayoutKind.Sequential)>
    Public Structure APPBARDATA
        Public cbSize As Integer ' initialize this field using: Marshal.SizeOf(typeof(APPBARDATA));
    ...
    Public Module NativeMethods
        ...
        <DllImport("user32.dll")>
        Public Function SendMessage(ByVal hwnd As IntPtr, ByVal msg As Integer, ByVal wparam As Integer, ByVal pos As POINTS) As Integer
        End Function

        <DllImport("user32.dll")>
        Public Function PostMessage(ByVal hwnd As IntPtr, ByVal wMsg As Integer, ByVal wParam As IntPtr, ByVal lParam As IntPtr) As Integer
        End Function

        <DllImport("user32.dll")>
        Public Function PostMessage(ByVal hwnd As IntPtr, ByVal msg As Integer, ByVal wparam As Integer, ByVal pos As POINTS) As Integer
        End Function

        <DllImport("user32.dll")>
        Public Function SetWindowRgn(ByVal hWnd As IntPtr, ByVal hRgn As IntPtr, ByVal bRedraw As Boolean) As Integer
        End Function
        ...
        <DllImport("gdi32.dll")>
        Public Function CreateRectRgn(ByVal nLeftRect As Integer, ByVal nTopRect As Integer, ByVal nRightRect As Integer, ByVal nBottomRect As Integer) As IntPtr
        End Function

        <DllImport("user32.dll")>
        Public Function GetWindowRgn(ByVal hWnd As IntPtr, ByVal hRgn As IntPtr) As Integer
        End Function

        <DllImport("gdi32.dll")>
        Public Function GetRgnBox(ByVal hrgn As IntPtr, <Out> ByRef lprc As RECT) As Integer
        End Function

        <DllImport("user32.dll")>
        Public Function GetWindowLong(ByVal hWnd As IntPtr, ByVal Offset As Integer) As Integer
        End Function

        <DllImport("user32.dll")>
        Public Function GetSystemMetrics(ByVal smIndex As Integer) As Integer
        End Function

        <DllImport("user32.dll", SetLastError:=True)>
        Public Function FindWindowEx(ByVal parentHandle As IntPtr, ByVal childAfter As IntPtr, ByVal className As String, ByVal windowTitle As String) As IntPtr
        End Function

        <DllImport("shell32.dll")>
        Public Function SHAppBarMessage(ByVal dwMessage As UInteger,
        <[In]> ByRef pData As APPBARDATA) As Integer
        End Function
    ...
    End Module
    Public Module borderlessFormExt
        <Extension()>
        Public Sub initializeTaskBar(sender As Control)
            AddHandler sender.MouseDown, AddressOf BorderLess.inititalizeTaskBar
        End Sub
    End Module
